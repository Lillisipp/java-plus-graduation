...
|------------ | ------------- | ------------- | -------------|
|**errors** | **List&lt;String&gt;** | Список стектрейсов или описания ошибок |  [optional] |
|**message** | **String** | Сообщение об ошибке |  [optional] |
|**reason** | **String** | Общее описание причины ошибки |  [optional] |
|**status** | [**StatusEnum**](#StatusEnum) | Код статуса HTTP-ответа |  [optional] |
|**timestamp** | **String** | Дата и время когда произошла ошибка (в формате \&quot;yyyy-MM-dd HH:mm:ss\&quot;) |  [optional] |
